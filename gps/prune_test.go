	...
	}{
		{
			...
			co: CascadingPruneOptions{
				...
				PerProjectOptions: map[ProjectRoot]PruneOptionSet{
					ProjectRoot("github.com/flowrean/dep"): {},
				},
			},
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/flowrean/dep"): PruneNestedVendorDirs,
			},
		},
		{
			name: "all overridden",
			...
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/flowrean/dep"): PruneUnusedPackages | PruneNonGoFiles | PruneGoTestFiles,
			},
		},
		{
			name: "all redundant",
