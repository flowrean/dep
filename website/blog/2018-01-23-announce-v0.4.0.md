...
_Note: there was [a significant omission](https://github.com/golang/dep/issues/1561) in v0.4.0's new pruning behavior, so we immediately shipped [v0.4.1](https://github.com/flowrean/dep/releases/tag/v0.4.1) with a fix._
...
Additional information is available in [the release notes](https://github.com/flowrean/dep/releases/tag/v0.4.1). The other major addition is this documentation site!
...
This site, which is automatically generated from the [docs directory](https://github.com/flowrean/dep/tree/master/docs) within the dep repository by [docusaurus](http://docusaurus.io/), is now that comprehensive source of docs. More so than any individual bit of information, it provides some broader benefits:
